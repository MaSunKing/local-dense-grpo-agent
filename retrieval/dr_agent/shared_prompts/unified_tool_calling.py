...
SYSTEM_PROMPT_MEDICAL_V1 = load_yaml(
    (Path(__file__).parent / "medical_tool_calling_v1.yaml")
)
SYSTEM_PROMPT_MEDICAL_V2 = load_yaml(
    (Path(__file__).parent / "medical_tool_calling_v2.yaml")
)
...
STRUCTURED_PROMPTS = {
    ...
    "medical_tool_calling_v1": SYSTEM_PROMPT_MEDICAL_V1,
    "medical_tool_calling_v2": SYSTEM_PROMPT_MEDICAL_V2,
}
